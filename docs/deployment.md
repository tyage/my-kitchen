...
[migration guide](migration.md) when moving an existing installation.
...
files or all service data. Restore instructions are in the [migration guide](migration.md).
